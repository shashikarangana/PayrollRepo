...
public class DeductionDTO {
    ...
    public DeductionDTO(String deductionId, String employeeId, double basicSalary, String date, double epf, double welFare, double insurance, double total, int deductStatus) {
    ...
    public String toString() {
        return "DeductionDTO{" + "deductionId=" + deductionId + ", employeeId=" + employeeId + ", basicSalary=" + basicSalary + ", date=" + date + ", epf=" + epf + ", welFare=" + welFare + ", insurance=" + insurance + ", total=" + total + ", deductStatus=" + deductStatus + '}';
    }

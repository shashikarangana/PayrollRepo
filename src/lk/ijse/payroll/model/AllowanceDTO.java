...
public class AllowanceDTO {
    ...
    public AllowanceDTO(String allowanceId, String employeeId, double basicSalary, String date, double houserentAllowance, double vehicleAllowance, double medical, double total, int payStatus) {
    ...
    public String toString() {
        return "AllowanceDTO{" + "allowanceId=" + allowanceId + ", employeeId=" + employeeId + ", basicSalary=" + basicSalary + ", date=" + date + ", houserentAllowance=" + houserentAllowance + ", vehicleAllowance=" + vehicleAllowance + ", medical=" + medical + ", total=" + total + ", payStatus=" + payStatus + '}';
    }

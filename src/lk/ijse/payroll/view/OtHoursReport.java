 ...
 * @author Chamil
 */
public class OtHoursReport extends javax.swing.JFrame {
    private String employeeName;

    /**
     * Creates new form OtHoursReport
     */
    public OtHoursReport() {
        initComponents();
        loadEmployeeNames();
    ...
    private void initComponents() {
        ...
        jPanel1.add(BtnView, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 260, -1, -1));

        BtnCancel.setText("Cancel");
        jPanel1.add(BtnCancel, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 260, 90, -1));
        ...
        jPanel1.add(jLabelBasicSalary, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 190, 110, 30));
        jPanel1.add(TextFieldDateOfBirth, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 190, 160, 30));
    ...
    private void BtnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnViewActionPerformed
        InputStream input=getClass().getResourceAsStream("/lk/ijse/payroll/report/otHoursReport.jasper");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OtHoursReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OtHoursReport().setVisible(true);
            }
        });
    }
